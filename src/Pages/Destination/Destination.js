            ...
            <div className='p-3 desc-container'>
              ...
              <div className='d-flex justify-content-between'>
                  <div className='text-warning'>
                    ...
                    <span className='text-muted'><small>(20 Reviews)</small></span>
                  </div>
                  <div>
                    <span className='text-muted mx-2'><small><FontAwesomeIcon icon={faClock} /></small></span>
                    <span><small>5 days</small></span>
                  </div>
              </div>
            </div>
          </div>
